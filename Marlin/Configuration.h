...
#define STRING_CONFIG_H_AUTHOR "(Joel)" // Who made the changes.
...
#define MACHINE_UUID "b20c688d-9379-471e-a52a-9de625bf57a7"
...
#define HOTEND_OFFSET_X { 0.0, -18 } // (mm) relative X-offset for each nozzle
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // FIND YOUR OWN: "M303 E0 C8 S200" to run autotune on the hotend at 200 degreesC for 8 cycles.
  // More info here: http://reprap.org/wiki/PID_Tuning
  #define DEFAULT_Kp 984.88
  #define DEFAULT_Ki 193.91
  #define DEFAULT_Kd 1250.55
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 96.25, 94.34 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, 28, -0.65 }
